...
assert.match(script, /\\u7f13\\u5b58\\u547d\\u4e2d\\u7387/);
assert.match(script, /hover tooltip \\u5df2\\u7ed8\\u5236/);
assert.match(script, /drawCacheLens/);
assert.match(script, /cache lens \\u5df2\\u7ed8\\u5236/);
assert.match(script, /tip-cache-bar/);
assert.match(script, /cache-meta/);
assert.match(script, /cache-health/);
assert.match(script, /cache-health-meta/);
assert.match(script, /hover focus rail \\u5df2\\u7ed8\\u5236/);
