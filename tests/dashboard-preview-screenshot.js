...
function makeElement(id) {
  const ctx = { scale(){}, setTransform(){}, clearRect(){}, fillRect(){}, beginPath(){}, moveTo(){}, lineTo(){}, quadraticCurveTo(){}, stroke(){}, fill(){}, fillText(){}, closePath(){}, save(){}, restore(){}, setLineDash(){}, arc(){}, roundRect(){}, measureText(text){ return { width: String(text || "").length * 7 }; }, createLinearGradient(){ return { addColorStop(){} }; }, createRadialGradient(){ return { addColorStop(){} }; } };
