...
<section class="range-filter" aria-label="\u7edf\u8ba1\u65f6\u95f4\u8303\u56f4"><div class="segmented-control"><button data-range="today">\u4eca\u5929</button><button data-range="window">24 \u5c0f\u65f6</button><button data-range="week">7 \u5929</button><button data-range="14d">14 \u5929</button><button data-range="30d">30 \u5929</button><button data-range="all">\u5168\u90e8</button><button data-range="custom">\u81ea\u5b9a\u4e49</button></div><select id="rangeSelect" class="range-select" aria-label="\u9009\u62e9\u65f6\u95f4\u8303\u56f4"><option value="today">\u4eca\u5929</option><option value="window">24 \u5c0f\u65f6</option><option value="week">7 \u5929</option><option value="14d">14 \u5929</option><option value="30d">30 \u5929</option><option value="all">\u5168\u90e8</option><option value="custom">\u81ea\u5b9a\u4e49\u2026</option></select><span id="rangeLabel" class="range-label">\u4eca\u5929</span></section>
...
<section class="surface trend-surface"><div class="surface-header"><div><span class="section-label">TOKEN FLOW</span><h2>\u4f7f\u7528\u8d8b\u52bf</h2></div><div class="chart-legend"><span><i class="total"></i>\u603b\u91cf</span><span><i class="output"></i>\u8f93\u51fa</span><span><i class="cache"></i>\u7f13\u5b58\u8bfb\u53d6</span></div></div><div class="chart-area"><canvas id="trendChart" aria-label="Token \u4f7f\u7528\u8d8b\u52bf\u56fe"></canvas><div class="chart-tooltip" data-chart-tooltip hidden></div><div id="chartEmpty" class="empty-state" hidden>\u5f53\u524d\u8303\u56f4\u6682\u65e0\u8d8b\u52bf\u6570\u636e</div></div></section>
<div class="content-grid"><section class="surface"><div class="surface-header"><div><span class="section-label">MODEL MIX / FILTERED</span><h2>\u6a21\u578b\u6392\u884c</h2></div></div><div id="models" class="rank-list"></div></section><section class="surface source-surface"><div class="surface-header"><div><span class="section-label">LOCAL SOURCES / FILTERED</span><h2>\u6570\u636e\u6e90\u5206\u5e03</h2></div></div><div class="source-layout"><div id="sourceRing" class="source-ring share-0"><div><strong id="sourceCount">0</strong><span>\u6570\u636e\u6e90</span></div></div><div id="sources" class="source-list"></div></div></section></div>
...
<section class="surface performance-surface"><div class="surface-header"><div><span id="performanceKicker" class="section-label">RESPONSE HEALTH</span><h2 id="performanceTitle">\u54cd\u5e94\u6027\u80fd</h2></div></div><div class="performance-grid"><div data-performance-only><span>\u5e73\u5747\u7b49\u5f85</span><strong id="perfLatency">\u2014</strong></div><div data-performance-only><span>P95 \u7b49\u5f85</span><strong id="perfP95">\u2014</strong></div><div data-performance-only><span>\u9996\u5185\u5bb9\u8fd1\u4f3c</span><strong id="perfFirst">\u2014</strong></div><div data-performance-only><span>\u8f93\u51fa\u901f\u5ea6</span><strong id="perfSpeed">\u2014</strong></div><div data-performance-only><span>\u6392\u961f\u5747\u503c</span><strong id="perfQueue">\u2014</strong></div><div><span>\u672c\u5730\u6570\u636e\u5e93</span><strong id="dbSize">\u2014</strong></div></div></section>
