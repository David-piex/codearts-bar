...
<section class="scope-filter" aria-label="\u7edf\u8ba1\u7ef4\u5ea6"><label><span>\u6570\u636e\u6765\u6e90</span><select id="sourceFilter"><option value="all">\u5168\u90e8\u6765\u6e90</option></select></label><label><span>\u6a21\u578b</span><select id="modelFilter"><option value="all">\u5168\u90e8\u6a21\u578b</option></select></label><p id="filterContext">\u4eca\u5929 \u00b7 \u5168\u90e8\u6765\u6e90 \u00b7 \u5168\u90e8\u6a21\u578b</p></section>
...
<section class="surface session-surface"><div class="surface-header"><div><span class="section-label">RECENT WORK</span><h2>\u6700\u8fd1\u4f1a\u8bdd</h2></div><button class="link-button session-full-link" data-action="openDashboard">\u67e5\u770b\u5b8c\u6574\u5206\u6790</button></div><div id="sessions" class="session-list"></div></section>
<section class="surface request-surface"><div class="surface-header"><div><span class="section-label">REQUEST LOG / FILTERED</span><h2>\u8bf7\u6c42\u65e5\u5fd7</h2></div><span id="requestCount" class="surface-meta">0 \u6761</span></div><div class="request-table-wrap"><table class="request-table"><thead><tr><th>\u65f6\u95f4</th><th>\u6765\u6e90</th><th>\u6a21\u578b</th><th>\u8f93\u5165</th><th>\u8f93\u51fa</th><th>\u521b\u5efa</th><th>\u547d\u4e2d</th><th>\u603b Token</th><th>\u8017\u65f6</th><th>\u72b6\u6001</th><th>\u4f1a\u8bdd</th></tr></thead><tbody id="requests"></tbody></table></div></section>
