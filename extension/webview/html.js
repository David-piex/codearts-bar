...
<section class="surface trend-surface"><div class="surface-header"><div><span class="section-label">TOKEN FLOW</span><h2>\u4f7f\u7528\u8d8b\u52bf</h2></div><div class="chart-legend"><span><i class="total"></i>\u603b\u91cf</span><span><i class="output"></i>\u8f93\u51fa</span></div></div><div class="chart-area"><canvas id="trendChart" aria-label="Token \u4f7f\u7528\u8d8b\u52bf\u56fe"></canvas><div class="chart-tooltip" data-chart-tooltip hidden></div><div id="chartEmpty" class="empty-state" hidden>\u5f53\u524d\u8303\u56f4\u6682\u65e0\u8d8b\u52bf\u6570\u636e</div></div></section>
