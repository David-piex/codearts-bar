...
<section id="customRange" class="custom-range" hidden><label><span>\u5f00\u59cb\u65f6\u95f4</span><div class="date-editor"><input id="rangeStart" type="text" inputmode="numeric" autocomplete="off" placeholder="YYYY-MM-DD HH:mm" aria-label="\u5f00\u59cb\u65f6\u95f4"><button class="date-picker-button" type="button" data-date-focus="rangeStart" title="\u9009\u62e9\u5f00\u59cb\u65f6\u95f4" aria-label="\u9009\u62e9\u5f00\u59cb\u65f6\u95f4"><span aria-hidden="true">\u25a6</span></button></div></label><span class="range-arrow" aria-hidden="true">\u2192</span><label><span>\u7ed3\u675f\u65f6\u95f4</span><div class="date-editor"><input id="rangeEnd" type="text" inputmode="numeric" autocomplete="off" placeholder="YYYY-MM-DD HH:mm" aria-label="\u7ed3\u675f\u65f6\u95f4"><button class="date-picker-button" type="button" data-date-focus="rangeEnd" title="\u9009\u62e9\u7ed3\u675f\u65f6\u95f4" aria-label="\u9009\u62e9\u7ed3\u675f\u65f6\u95f4"><span aria-hidden="true">\u25a6</span></button></div></label><p id="rangeError" role="alert" hidden></p><div><button data-range-cancel>\u53d6\u6d88</button><button class="accent-button" data-range-apply>\u5e94\u7528</button></div></section>
